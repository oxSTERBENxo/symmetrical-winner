...
//        if (list.get(1) != null) list.remove(1); Не работи со null да споредуваш integers
        ...
        // Бројчињава личат смешно на почеток кога ќе ги прочиташ и ќе се запрашаш зошто ги задавам?
        ...
        // 1 4 8 13 19 26 ... но откако ми излегоа 3 IndexOutOfBoundsException набрзо сфатив дека
        // не е толку идеален светот во кој жиевееме.
        ...
        //   2    5      9            14              20                   х  (избришани елементи, х значи дека тој елемент
        //                                                                       треба да се брише)
        ...
        // Во 24та линија, проверувам дали големината на листата е поголема од индексот кој што сакам да го избришам
        // со цел да спречам IndexOutOfBoundsException
    }
